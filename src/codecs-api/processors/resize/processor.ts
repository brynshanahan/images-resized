import wasmUrl from 'squoosh/codecs/resize/pkg/resize_bg.wasm'
import 'src/lib/squoosh/codecs/resize/pkg/resize'
import { WorkerResizeOptions } from './processor-meta'
import { getContainOffsets } from './util'

interface WasmBindgenExports {
  resize: typeof import('squoosh/codecs/resize/pkg/resize').resize
}
...
function crop(
  ...
  const inputPixels = new Uint32Array(data.data.buffer.slice(0))
